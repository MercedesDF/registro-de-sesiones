...
// --- Paleta de Colores del Tema Verde ---
const ACCENT_COLOR = '#22C55E'; // green-500
const ACCENT_HOVER_COLOR_CLASS = 'hover:bg-green-600';
const FOOTER_BG_COLOR = '#14532D'; // green-900
const FOOTER_TEXT_COLOR = '#DCFCE7'; // green-100
const TEXT_ON_ACCENT_COLOR = 'white'; // Texto sobre botones de acento
const LINK_BASE_COLOR_CLASS = 'text-green-300'; // Color claro para contraste en footer oscuro
const LINK_HOVER_COLOR_CLASS = 'hover:text-green-200';
    ...
    <>
      ...
      >
        {activeSession ? (
          ...
          <>
            <Header />
            <main className="flex-grow p-4 overflow-y-auto text-center"> {/* Scroll interno y texto centrado */}
              ...
              <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-2 items-center">
                ...
                <div className="flex flex-col items-center md:items-end space-y-1">
                  ...
                  <div className="flex items-center space-x-3">
                    <a href="https://github.com/MercedesDF/registro-de-sesiones" target="_blank" rel="noopener noreferrer" aria-label="GitHub de mercedev" className={`${LINK_BASE_COLOR_CLASS} ${LINK_HOVER_COLOR_CLASS} transition-colors`}>
